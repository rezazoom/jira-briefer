...
- **Two Output Formats:**
  ...
  - **HTML** — Self-contained, styled, RTL/Persian report with accordion UI, stat cards, clickable links to each Jira task, and the Arad font embedded (renders anywhere, no install needed)
